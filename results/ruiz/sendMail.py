...
df = pd.read_csv('gaps_ruiz.csv', sep='\t', usecols=[2, 3, 4, 5, 6, 7])

lit = df['LITERATURA'].mean()
...
df_resumo = pd.DataFrame(data=[[lit, melhor, pior, media, mediana, gap]],
                        columns=['LITERATURA', 'MELHOR', 'PIOR', 'MEDIA', 'MEDIANA', 'GAP'])
